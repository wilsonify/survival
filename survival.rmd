...
defined origin to a well-defined event. A second characteristic of survival analysis,1.3 Survival Data and Censoring
3
...
example.4
1 Introduction
Example 1.1. Consider a hypothetical cancer clinical trial where subjects enter the
...
20101.3 Survival Data and Censoring
...
Age Gender OS Death RFS Recurrence
CXCL17T CD4N
Ki67
1
57
...
the event rate per person-week.Chapter 2
...
D. Moore, Applied Survival Analysis Using R, Use R!,
...
Example 2.1. The daily hazard rates of men and women by age in each calendar
...
Moeschberger [36] and Cox and Oakes [11] for details.2.5 Computing the Survival Function from the Hazard Function
...
theory is beyond the scope of this book, we may get an overview of the technique2.6 A Brief Introduction to Maximum Likelihood Estimation
21
...
2 Basic Principles of Survival Analysis
Exercises
2.1. Using the “survexp.us” data described in Example 2.2, plot the hazard func-
...
2.5. Consider a survival distribution with constant hazard  D 0:07 from t D 0
...
would have if it followed one of these hazard functions.Chapter 3
...
© Springer International Publishing Switzerland 2016
D. Moore, Applied Survival Analysis Using R, Use R!,
DOI 10.1007/978-3-319-31245-3_3
2526
...
to the estimate presented in Sect. 3.4.Chapter 4
Nonparametric Comparison of Survival
Distributions
...
of the Gehan test. Do these two tests yield different results?Chapter 5
Regression Analysis Using the Proportional
Hazards Model
...
© Springer International Publishing Switzerland 2016
D. Moore, Applied Survival Analysis Using R, Use R!,
DOI 10.1007/978-3-319-31245-3_5
5556
...
© Springer International Publishing Switzerland 2016
D. Moore, Applied Survival Analysis Using R, Use R!,
DOI 10.1007/978-3-319-31245-3_6
7374
...
(b) recurrence-free survival.Chapter 7
Model Diagnostics
...
© Springer International Publishing Switzerland 2016
D. Moore, Applied Survival Analysis Using R, Use R!,
DOI 10.1007/978-3-319-31245-3_7
8788
7 Model Diagnostics
...
``` par(mfrow=c(2,2))7.1 Assessing Goodness of Fit Using Residuals
91
``` plot(rr.final ~ age)
...
© Springer International Publishing Switzerland 2016
D. Moore, Applied Survival Analysis Using R, Use R!,
DOI 10.1007/978-3-319-31245-3_8
101102
...
the time transfer function. Do the results differ? Why?Chapter 9
Multiple Survival Outcomes
and Competing Risks
...
© Springer International Publishing Switzerland 2016
D. Moore, Applied Survival Analysis Using R, Use R!,
DOI 10.1007/978-3-319-31245-3_9
113114
...
instead of 85 and above.Chapter 10
Parametric Models
10.1 Introduction
...
© Springer International Publishing Switzerland 2016
D. Moore, Applied Survival Analysis Using R, Use R!,
DOI 10.1007/978-3-319-31245-3_10
137138
...
© Springer International Publishing Switzerland 2016
D. Moore, Applied Survival Analysis Using R, Use R!,
DOI 10.1007/978-3-319-31245-3_12
177178
